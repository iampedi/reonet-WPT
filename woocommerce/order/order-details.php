...
?>
<section class="woocommerce_order_details overflow-hidden sm:col-span-2">
	<div class="card wa-inline-card">
		<?php do_action('woocommerce_order_details_before_order_table', $order); ?>

		<div class="card-head">
			<h2 class="woocommerce_order_details_title"><?php esc_html_e('Order details', 'woocommerce'); ?></h2>
		</div>
