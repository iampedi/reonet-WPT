...
?>
<div class="wc_payment_method _payment-method payment_method_<?php echo esc_attr($gateway_id); ?>">
	<label for="payment_method_<?php echo esc_attr($gateway_id); ?>" class="_reonet_payment_method_label flex cursor-pointer items-center gap-3 pb-2">
		<span class="_payment-method-content flex min-w-0 flex-1 items-center justify-between gap-3">
			<span class="_payment-method-main flex min-w-0 items-center gap-2.5">
				<i class="ph-duotone <?php echo esc_attr($leading_icon_class); ?> _payment-method-leading-icon text-3xl text-green"></i>
			...
			<span class="_payment-method-brand-icons shrink-0"><?php echo $payment_brand_icons; /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></span>
		</span>
